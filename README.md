...
Це по факту порожній об'єкт. Ми так само можемо написати так:
...
Тут ми вказуємо, що об'єкт user має бути об'єктом, який має властивість name типу string і властивість age типу number.
